...
sealed class HomeFilterState with _$HomeFilterState {
  ...
  const factory HomeFilterState.loaded({@Default(HomeFilter()) HomeFilter filter}) = Loaded;
  const factory HomeFilterState.filtering({@Default(HomeFilter()) HomeFilter filter}) = Filtering;
