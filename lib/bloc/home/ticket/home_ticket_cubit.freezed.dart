...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<Ticket> tickets)?  refreshing,TResult Function( List<Ticket> tickets)?  loadingMore,TResult Function( List<Ticket> tickets,  int pageIndex)?  loaded,TResult Function( String message)?  failed,TResult Function()?  empty,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<Ticket> tickets)  refreshing,required TResult Function( List<Ticket> tickets)  loadingMore,required TResult Function( List<Ticket> tickets,  int pageIndex)  loaded,required TResult Function( String message)  failed,required TResult Function()  empty,}) {final _that = this;
switch (_that) {
case Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<Ticket> tickets)?  refreshing,TResult? Function( List<Ticket> tickets)?  loadingMore,TResult? Function( List<Ticket> tickets,  int pageIndex)?  loaded,TResult? Function( String message)?  failed,TResult? Function()?  empty,}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Refreshing() when refreshing != null:
...
class Refreshing implements HomeTicketState {
  const Refreshing(final  List<Ticket> tickets): _tickets = tickets;
...
class LoadingMore implements HomeTicketState {
  const LoadingMore(final  List<Ticket> tickets): _tickets = tickets;
...
class Loaded implements HomeTicketState {
  const Loaded(final  List<Ticket> tickets, this.pageIndex): _tickets = tickets;
...
@useResult
$Res call({
 List<Ticket> tickets, int pageIndex
});
...
@pragma('vm:prefer-inline') $Res call({Object? tickets = null,Object? pageIndex = null,}) {
  return _then(Loaded(
null == tickets ? _self._tickets : tickets // ignore: cast_nullable_to_non_nullable
as List<Ticket>,null == pageIndex ? _self.pageIndex : pageIndex // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
