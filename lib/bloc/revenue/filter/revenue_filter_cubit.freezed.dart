...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RevenueFilterState);
}
...
/// @nodoc
class $RevenueFilterStateCopyWith<$Res>  {
$RevenueFilterStateCopyWith(RevenueFilterState _, $Res Function(RevenueFilterState) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( RevenueFilter filter)?  loaded,TResult Function( RevenueFilter filter)?  filtering,TResult Function( String message)?  failed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( RevenueFilter filter)  loaded,required TResult Function( RevenueFilter filter)  filtering,required TResult Function( String message)  failed,}) {final _that = this;
switch (_that) {
case Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( RevenueFilter filter)?  loaded,TResult? Function( RevenueFilter filter)?  filtering,TResult? Function( String message)?  failed,}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Loaded() when loaded != null:
...
@override
String toString() {
  return 'RevenueFilterState.initial()';
}
...
@override
String toString() {
  return 'RevenueFilterState.loading()';
}
...
@JsonKey() final  RevenueFilter filter;
...
@override
String toString() {
  return 'RevenueFilterState.failed(message: $message)';
}
