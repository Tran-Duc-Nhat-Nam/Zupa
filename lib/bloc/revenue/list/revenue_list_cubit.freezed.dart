...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<DailyRevenue> revenue)?  refreshing,TResult Function( List<DailyRevenue> revenue)?  loadingMore,TResult Function( List<DailyRevenue> revenue,  int pageIndex)?  loaded,TResult Function( String message)?  failed,TResult Function()?  empty,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Refreshing() when refreshing != null:
return refreshing(_that.revenue);case LoadingMore() when loadingMore != null:
return loadingMore(_that.revenue);case Loaded() when loaded != null:
return loaded(_that.revenue,_that.pageIndex);case Failed() when failed != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<DailyRevenue> revenue)  refreshing,required TResult Function( List<DailyRevenue> revenue)  loadingMore,required TResult Function( List<DailyRevenue> revenue,  int pageIndex)  loaded,required TResult Function( String message)  failed,required TResult Function()  empty,}) {final _that = this;
switch (_that) {
case Initial():
return initial();case Loading():
return loading();case Refreshing():
return refreshing(_that.revenue);case LoadingMore():
return loadingMore(_that.revenue);case Loaded():
return loaded(_that.revenue,_that.pageIndex);case Failed():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<DailyRevenue> revenue)?  refreshing,TResult? Function( List<DailyRevenue> revenue)?  loadingMore,TResult? Function( List<DailyRevenue> revenue,  int pageIndex)?  loaded,TResult? Function( String message)?  failed,TResult? Function()?  empty,}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Refreshing() when refreshing != null:
...
class Refreshing implements RevenueListState {
  const Refreshing(final  List<DailyRevenue> revenue): _revenue = revenue;
  

 final  List<DailyRevenue> _revenue;
 List<DailyRevenue> get revenue {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Refreshing&&const DeepCollectionEquality().equals(other._revenue, _revenue));
}
...
@override
String toString() {
  return 'RevenueListState.refreshing(revenue: $revenue)';
}
...
/// Create a copy of RevenueListState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? revenue = null,}) {
  return _then(Refreshing(
null == revenue ? _self._revenue : revenue // ignore: cast_nullable_to_non_nullable
...
class LoadingMore implements RevenueListState {
  const LoadingMore(final  List<DailyRevenue> revenue): _revenue = revenue;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoadingMore&&const DeepCollectionEquality().equals(other._revenue, _revenue));
}
...
@override
String toString() {
  return 'RevenueListState.loadingMore(revenue: $revenue)';
}
...
class Loaded implements RevenueListState {
  const Loaded(final  List<DailyRevenue> revenue, this.pageIndex): _revenue = revenue;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Loaded&&const DeepCollectionEquality().equals(other._revenue, _revenue)&&(identical(other.pageIndex, pageIndex) || other.pageIndex == pageIndex));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_revenue),pageIndex);

@override
String toString() {
  return 'RevenueListState.loaded(revenue: $revenue, pageIndex: $pageIndex)';
}
...
@useResult
$Res call({
 List<DailyRevenue> revenue, int pageIndex
});
...
/// Create a copy of RevenueListState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? revenue = null,Object? pageIndex = null,}) {
  return _then(Loaded(
null == revenue ? _self._revenue : revenue // ignore: cast_nullable_to_non_nullable
