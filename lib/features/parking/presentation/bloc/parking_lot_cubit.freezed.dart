...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ParkingLotState);
}
...
/// @nodoc
class $ParkingLotStateCopyWith<$Res>  {
$ParkingLotStateCopyWith(ParkingLotState _, $Res Function(ParkingLotState) __);
}


/// Adds pattern-matching-related methods to [ParkingLotState].
extension ParkingLotStatePatterns on ParkingLotState {
...
class Initial implements ParkingLotState {
  const Initial();
...
@override
String toString() {
  return 'ParkingLotState.initial()';
}
...
class Loading implements ParkingLotState {
  const Loading();
...
@override
String toString() {
  return 'ParkingLotState.loading()';
}
...
class Refreshing implements ParkingLotState {
...
@override
String toString() {
  return 'ParkingLotState.refreshing(parkingLots: $parkingLots)';
}
...
/// @nodoc
abstract mixin class $RefreshingCopyWith<$Res> implements $ParkingLotStateCopyWith<$Res> {
...
class LoadingMore implements ParkingLotState {
...
@override
String toString() {
  return 'ParkingLotState.loadingMore(parkingLots: $parkingLots)';
}
...
/// @nodoc
abstract mixin class $LoadingMoreCopyWith<$Res> implements $ParkingLotStateCopyWith<$Res> {
...
class Loaded implements ParkingLotState {
...
@override
String toString() {
  return 'ParkingLotState.loaded(parkingLots: $parkingLots, pageIndex: $pageIndex)';
}
...
/// @nodoc
abstract mixin class $LoadedCopyWith<$Res> implements $ParkingLotStateCopyWith<$Res> {
...
class Failed implements ParkingLotState {
...
@override
String toString() {
  return 'ParkingLotState.failed(message: $message)';
}
...
/// @nodoc
abstract mixin class $FailedCopyWith<$Res> implements $ParkingLotStateCopyWith<$Res> {
...
class Empty implements ParkingLotState {
  const Empty();
...
class Unauthenticated implements ParkingLotState {
...
@override
String toString() {
  return 'ParkingLotState.unauthenticated()';
}
