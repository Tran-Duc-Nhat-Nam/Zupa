...
mixin _$MemberVehicle {
 ...
 String get id; String get name; String get phoneNumber; String get licenseNumber; String get parkingLotId; VehicleType get vehicleType; String get cardId; int get expiredIn; int get price;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,phoneNumber,licenseNumber,parkingLotId,vehicleType,cardId,expiredIn,price);

@override
String toString() {
  return 'MemberVehicle(id: $id, name: $name, phoneNumber: $phoneNumber, licenseNumber: $licenseNumber, parkingLotId: $parkingLotId, vehicleType: $vehicleType, cardId: $cardId, expiredIn: $expiredIn, price: $price)';
}
...
@useResult
$Res call({
 String id, String name, String phoneNumber, String licenseNumber, String parkingLotId, VehicleType vehicleType, String cardId, int expiredIn, int price
});
...
/// Create a copy of MemberVehicle
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? phoneNumber = null,Object? licenseNumber = null,Object? parkingLotId = null,Object? vehicleType = null,Object? cardId = null,Object? expiredIn = null,Object? price = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String phoneNumber,  String licenseNumber,  String parkingLotId,  VehicleType vehicleType,  String cardId,  int expiredIn,  int price)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MemberVehicle() when $default != null:
return $default(_that.id,_that.name,_that.phoneNumber,_that.licenseNumber,_that.parkingLotId,_that.vehicleType,_that.cardId,_that.expiredIn,_that.price);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String phoneNumber,  String licenseNumber,  String parkingLotId,  VehicleType vehicleType,  String cardId,  int expiredIn,  int price)  $default,) {final _that = this;
switch (_that) {
case _MemberVehicle():
return $default(_that.id,_that.name,_that.phoneNumber,_that.licenseNumber,_that.parkingLotId,_that.vehicleType,_that.cardId,_that.expiredIn,_that.price);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String phoneNumber,  String licenseNumber,  String parkingLotId,  VehicleType vehicleType,  String cardId,  int expiredIn,  int price)?  $default,) {final _that = this;
switch (_that) {
case _MemberVehicle() when $default != null:
return $default(_that.id,_that.name,_that.phoneNumber,_that.licenseNumber,_that.parkingLotId,_that.vehicleType,_that.cardId,_that.expiredIn,_that.price);case _:
  return null;
...
class _MemberVehicle implements MemberVehicle {
  const _MemberVehicle({this.id = 'N/A', this.name = 'N/A', this.phoneNumber = 'N/A', this.licenseNumber = 'N/A', this.parkingLotId = 'N/A', this.vehicleType = const VehicleType(), this.cardId = 'N/A', this.expiredIn = 86400, this.price = 0});
...
/// Create a copy of MemberVehicle
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? phoneNumber = null,Object? licenseNumber = null,Object? parkingLotId = null,Object? vehicleType = null,Object? cardId = null,Object? expiredIn = null,Object? price = null,}) {
