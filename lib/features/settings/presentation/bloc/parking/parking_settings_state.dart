...
sealed class ParkingSettingsState with _$ParkingSettingsState {
  ...
  const factory ParkingSettingsState.refreshing(List<ParkingLot> parkingLots) =
      Refreshing;
  const factory ParkingSettingsState.loadingMore(List<ParkingLot> parkingLots) =
      LoadingMore;
  const factory ParkingSettingsState.loaded(
