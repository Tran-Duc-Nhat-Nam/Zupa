...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HistoryFilterState);
}
...
/// @nodoc
class $HistoryFilterStateCopyWith<$Res>  {
$HistoryFilterStateCopyWith(HistoryFilterState _, $Res Function(HistoryFilterState) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( HistoryFilter filter)?  loaded,TResult Function( HistoryFilter filter)?  filtering,TResult Function( String message)?  failed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( HistoryFilter filter)  loaded,required TResult Function( HistoryFilter filter)  filtering,required TResult Function( String message)  failed,}) {final _that = this;
switch (_that) {
case Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( HistoryFilter filter)?  loaded,TResult? Function( HistoryFilter filter)?  filtering,TResult? Function( String message)?  failed,}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Loaded() when loaded != null:
...
class Initial implements HistoryFilterState {
  const Initial();
...
@override
String toString() {
  return 'HistoryFilterState.initial()';
}
...
class Loading implements HistoryFilterState {
  const Loading();
...
@override
String toString() {
  return 'HistoryFilterState.loading()';
}
...
class Loaded implements HistoryFilterState {
  const Loaded({this.filter = const HistoryFilter()});
  

@JsonKey() final  HistoryFilter filter;
...
@override
String toString() {
  return 'HistoryFilterState.loaded(filter: $filter)';
}
...
/// @nodoc
abstract mixin class $LoadedCopyWith<$Res> implements $HistoryFilterStateCopyWith<$Res> {
...
$HistoryFilterCopyWith<$Res> get filter;
...
$HistoryFilterCopyWith<$Res> get filter {
  ...
  return $HistoryFilterCopyWith<$Res>(_self.filter, (value) {
...
class Filtering implements HistoryFilterState {
  const Filtering({this.filter = const HistoryFilter()});
...
@override
String toString() {
  return 'HistoryFilterState.filtering(filter: $filter)';
}
...
/// @nodoc
abstract mixin class $FilteringCopyWith<$Res> implements $HistoryFilterStateCopyWith<$Res> {
...
class Failed implements HistoryFilterState {
...
@override
String toString() {
  return 'HistoryFilterState.failed(message: $message)';
}
...
/// @nodoc
abstract mixin class $FailedCopyWith<$Res> implements $HistoryFilterStateCopyWith<$Res> {
