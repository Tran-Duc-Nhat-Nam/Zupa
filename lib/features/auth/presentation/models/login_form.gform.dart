...
class LoginForm implements FormModel<Login, Login> {
  ...
  static const String isRememberControlName = "isRemember";
  ...
  String isRememberControlPath() => pathBuilder(isRememberControlName);

  String get _tenantValue => tenantControl.value ?? '';

  String get _usernameValue => usernameControl.value ?? '';

  String get _passwordValue => passwordControl.value ?? '';

  bool get _isRememberValue => isRememberControl.value ?? false;

  String get _tenantRawValue => tenantControl.value ?? '';

  String get _usernameRawValue => usernameControl.value ?? '';

  String get _passwordRawValue => passwordControl.value ?? '';

  bool get _isRememberRawValue => isRememberControl.value ?? false;
  ...
  bool get containsIsRemember {
    try {
      form.control(isRememberControlPath());
      return true;
    } catch (e) {
      return false;
    }
  ...
  Map<String, dynamic> get tenantErrors => tenantControl.errors;

  Map<String, dynamic> get usernameErrors => usernameControl.errors;

  Map<String, dynamic> get passwordErrors => passwordControl.errors;

  Map<String, dynamic> get isRememberErrors => isRememberControl.errors;
  ...
  void get isRememberFocus => form.focus(isRememberControlPath());
  ...
  void isRememberValueUpdate(
    bool value, {
    bool updateParent = true,
    bool emitEvent = true,
  }) {
    isRememberControl.updateValue(
      value,
      updateParent: updateParent,
      emitEvent: emitEvent,
    );
  ...
  void isRememberValuePatch(
    bool value, {
    bool updateParent = true,
    bool emitEvent = true,
  }) {
    isRememberControl.patchValue(
      value,
      updateParent: updateParent,
      emitEvent: emitEvent,
    );
  ...
  void isRememberValueReset(
    bool value, {
    bool updateParent = true,
    bool emitEvent = true,
    bool removeFocus = false,
    bool? disabled,
  }) => isRememberControl.reset(
    value: value,
    updateParent: updateParent,
    emitEvent: emitEvent,
    removeFocus: removeFocus,
  ...
  FormControl<String> get tenantControl =>
      form.control(tenantControlPath()) as FormControl<String>;
  ...
  FormControl<bool> get isRememberControl =>
      form.control(isRememberControlPath()) as FormControl<bool>;
  ...
  void isRememberSetDisabled(
    bool disabled, {
    bool updateParent = true,
    bool emitEvent = true,
  }) {
    if (disabled) {
      isRememberControl.markAsDisabled(
        updateParent: updateParent,
        emitEvent: emitEvent,
      );
    } else {
      isRememberControl.markAsEnabled(
        updateParent: updateParent,
        emitEvent: emitEvent,
      );
    }
  ...
  Login get rawModel {
    return Login(
      tenant: _tenantRawValue,
      username: _usernameRawValue,
      password: _passwordRawValue,
      isRemember: _isRememberRawValue,
    );
  }
  ...
  static FormGroup formElements(Login? login) => FormGroup(
    {
      tenantControlName: FormControl<String>(
        value: login?.tenant,
      ...
      isRememberControlName: FormControl<bool>(
        value: login?.isRemember,
        validators: [RequiredValidator()],
        asyncValidators: [],
        asyncValidatorsDebounceTime: 250,
        disabled: false,
