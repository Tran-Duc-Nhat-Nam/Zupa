...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeTicketState);
}
...
/// @nodoc
class $HomeTicketStateCopyWith<$Res>  {
$HomeTicketStateCopyWith(HomeTicketState _, $Res Function(HomeTicketState) __);
}


/// Adds pattern-matching-related methods to [HomeTicketState].
extension HomeTicketStatePatterns on HomeTicketState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<HomeTicket> tickets)?  refreshing,TResult Function( List<HomeTicket> tickets)?  loadingMore,TResult Function( List<HomeTicket> tickets,  int pageIndex)?  loaded,TResult Function( String message)?  failed,TResult Function()?  empty,TResult Function()?  unauthenticated,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<HomeTicket> tickets)  refreshing,required TResult Function( List<HomeTicket> tickets)  loadingMore,required TResult Function( List<HomeTicket> tickets,  int pageIndex)  loaded,required TResult Function( String message)  failed,required TResult Function()  empty,required TResult Function()  unauthenticated,}) {final _that = this;
switch (_that) {
case Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<HomeTicket> tickets)?  refreshing,TResult? Function( List<HomeTicket> tickets)?  loadingMore,TResult? Function( List<HomeTicket> tickets,  int pageIndex)?  loaded,TResult? Function( String message)?  failed,TResult? Function()?  empty,TResult? Function()?  unauthenticated,}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Refreshing() when refreshing != null:
...
class Initial implements HomeTicketState {
  const Initial();
...
@override
String toString() {
  return 'HomeTicketState.initial()';
}
...
class Loading implements HomeTicketState {
  const Loading();
...
@override
String toString() {
  return 'HomeTicketState.loading()';
}
...
class Refreshing implements HomeTicketState {
  const Refreshing(final  List<HomeTicket> tickets): _tickets = tickets;
  

 final  List<HomeTicket> _tickets;
 List<HomeTicket> get tickets {
...
/// Create a copy of HomeTicketState
...
@override
String toString() {
  return 'HomeTicketState.refreshing(tickets: $tickets)';
}
...
/// @nodoc
abstract mixin class $RefreshingCopyWith<$Res> implements $HomeTicketStateCopyWith<$Res> {
...
class LoadingMore implements HomeTicketState {
  const LoadingMore(final  List<HomeTicket> tickets): _tickets = tickets;
...
@override
String toString() {
  return 'HomeTicketState.loadingMore(tickets: $tickets)';
}
...
/// @nodoc
abstract mixin class $LoadingMoreCopyWith<$Res> implements $HomeTicketStateCopyWith<$Res> {
...
class Loaded implements HomeTicketState {
  const Loaded(final  List<HomeTicket> tickets, this.pageIndex): _tickets = tickets;
...
@override
String toString() {
  return 'HomeTicketState.loaded(tickets: $tickets, pageIndex: $pageIndex)';
}
...
/// @nodoc
abstract mixin class $LoadedCopyWith<$Res> implements $HomeTicketStateCopyWith<$Res> {
  factory $LoadedCopyWith(Loaded value, $Res Function(Loaded) _then) = _$LoadedCopyWithImpl;
@useResult
$Res call({
 List<HomeTicket> tickets, int pageIndex
});
...
@pragma('vm:prefer-inline') $Res call({Object? tickets = null,Object? pageIndex = null,}) {
  return _then(Loaded(
null == tickets ? _self._tickets : tickets // ignore: cast_nullable_to_non_nullable
as List<HomeTicket>,null == pageIndex ? _self.pageIndex : pageIndex // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class Failed implements HomeTicketState {
...
@override
String toString() {
  return 'HomeTicketState.failed(message: $message)';
}
...
/// @nodoc
abstract mixin class $FailedCopyWith<$Res> implements $HomeTicketStateCopyWith<$Res> {
...
class Emtpy implements HomeTicketState {
  const Emtpy();
...
class Unauthenticated implements HomeTicketState {
...
@override
String toString() {
  return 'HomeTicketState.unauthenticated()';
}
