...
import '../../../bloc/settings/parking/parking_settings_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return AppScreen(
      ...
      child: BlocProvider<ParkingSettingsCubit>(
        create: (context) => ParkingSettingsCubit()..init(),
          ...
          builder: (context, state) {
            return Skeletonizer(
              ...
              child: Padding(
                ...
                child: AppCard(
                  child: switch (state) {
                    Loaded(:final parkingLots) => ListView.separated(
                      shrinkWrap: true,
                      itemBuilder:
