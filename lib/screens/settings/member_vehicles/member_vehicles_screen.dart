...
import '../../../bloc/member_vehicles/filter/member_vehicles_filter_cubit.dart'
    as filter;
      ...
      child: MultiBlocProvider(
        providers: [
          BlocProvider<MemberVehiclesListCubit>(
            create: (context) => MemberVehiclesListCubit()..init(context),
          ),
          BlocProvider<filter.MemberVehiclesFilterCubit>(
            create:
                (context) =>
                    filter.MemberVehiclesFilterCubit()
