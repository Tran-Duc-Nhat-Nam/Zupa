...
class BiometricService {
  ...
  Future<bool> get isEnabled async => await _storageService.getBiometricAuth() == true;
  ...
  Future<bool> authenticate() async {
    ...
    if (!canAuthenticate) {
       throw BiometricError(code: 'no_hardware', message: 'Biometric authentication is not available');
    }

    final List<BiometricType> availableBiometrics = await _auth.getAvailableBiometrics();

    if (availableBiometrics.isEmpty) {
        throw BiometricError(code: 'no_enrolled', message: 'Biometric authentication is not enrolled');
    }
