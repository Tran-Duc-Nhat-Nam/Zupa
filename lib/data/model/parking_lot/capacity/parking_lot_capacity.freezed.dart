...
mixin _$ParkingLotCapacity {
 ...
 VehicleType get vehicleType; int get capacity;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ParkingLotCapacity&&(identical(other.vehicleType, vehicleType) || other.vehicleType == vehicleType)&&(identical(other.capacity, capacity) || other.capacity == capacity));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,vehicleType,capacity);

@override
String toString() {
  return 'ParkingLotCapacity(vehicleType: $vehicleType, capacity: $capacity)';
}
...
@useResult
$Res call({
 VehicleType vehicleType, int capacity
});
...
/// Create a copy of ParkingLotCapacity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? vehicleType = null,Object? capacity = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( VehicleType vehicleType,  int capacity)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ParkingLotCapacity() when $default != null:
return $default(_that.vehicleType,_that.capacity);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( VehicleType vehicleType,  int capacity)  $default,) {final _that = this;
switch (_that) {
case _ParkingLotCapacity():
return $default(_that.vehicleType,_that.capacity);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( VehicleType vehicleType,  int capacity)?  $default,) {final _that = this;
switch (_that) {
case _ParkingLotCapacity() when $default != null:
return $default(_that.vehicleType,_that.capacity);case _:
  return null;
...
class _ParkingLotCapacity implements ParkingLotCapacity {
  const _ParkingLotCapacity({this.vehicleType = const VehicleType(), this.capacity = 0});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ParkingLotCapacity&&(identical(other.vehicleType, vehicleType) || other.vehicleType == vehicleType)&&(identical(other.capacity, capacity) || other.capacity == capacity));
}
...
/// Create a copy of ParkingLotCapacity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? vehicleType = null,Object? capacity = null,}) {
